...
#pragma endregion
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::X))
	{
		...
		{
			m_v3Rotation.x += 0.1f;
			quaternion q1 = glm::angleAxis(0.05f, vector3(1.0f, 0.0f, 0.0f));
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
	{
		if (fMultiplier)
			...
			m_v3Rotation.y += 0.1f;
			quaternion q1 = glm::angleAxis(0.05f, vector3(0.0f, 1.0f, 0.0f));
			m_qOrientation = m_qOrientation * q1;
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
	{
		if (fMultiplier)
			...
			m_v3Rotation.z += 0.1f;
			quaternion q1 = glm::angleAxis(0.05f, vector3(0.0f, 0.0f, 1.0f));
			m_qOrientation = m_qOrientation * q1;
	}
